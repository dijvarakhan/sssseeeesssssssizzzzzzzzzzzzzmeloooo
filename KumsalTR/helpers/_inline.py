...
class Inline:
    ...
    def help_markup(self, _lang: dict, back=False):
        if back:
            ...
            rows = [
                ...
                # 4. Satır: Yetki + Engel
                [
                    _ikb(text="ʏᴇᴛᴋɪʟᴇʀ", callback_data="help auth", style="primary", icon_custom_emoji_id=EMOJI_MOON),
                    _ikb(text="ᴇɴɢᴇʟʟᴇʀ", callback_data="help blist", style="primary", icon_custom_emoji_id=EMOJI_STOP)
                ],
                # 5. Satır: Dil + Hız
                [
                    _ikb(text="ᴅɪʟʟᴇʀ", callback_data="help lang", style="primary", icon_custom_emoji_id=EMOJI_WAVE),
                    _ikb(text="ʜɪᴢ", callback_data="help ping", style="primary", icon_custom_emoji_id=EMOJI_SKIP)
                ],
                # 6. Satır: Geliştirici (Sudo) + İndirici
                [
                ...
                # 7. Satır: Ana Menü / Kapat - Tam Genişlik Kırmızı
                [
    ...
    def radio_markup(self, lang: dict):
        stations = [
            ("ALEM", "alem"), ("JOY FM", "joy"), ("GENÇ FM", "genc"),
            ("RADYO7", "r7"), ("POWER TÜRK", "pturk"), ("POWER LOVE", "plove"),
            ("SLOW", "slow"), ("KRAL", "kral"), ("K POP", "kpop"),
            ("NUMBER1", "n1"), ("NUMBER1 TURK", "n1turk"), ("BABA", "baba"),
            ("RADYO D", "radyod"), ("SEYMEN", "seymen"), ("SÜPER", "super"),
            ("VIRGIN", "virgin"), ("SESİNİZ", "sesiniz"), ("45'LİK", "45lik"),
            ("90's FM", "90s"), ("ATURKA", "aturka"), ("AŞK FM", "ask"),
            ("VTURKA", "vturka"), ("ROMANTİK", "romantik"), ("METRO", "metro"),
            ("FENOMEN", "fenomen"), ("ARABESK", "arabesk"), ("EFKAR", "efkar"),
            ("MYDONOSE", "mydonose"), ("SLW HITS", "slw"), ("BANKO", "banko"),
            ("BAYRAM", "bayram"), ("KALP FM", "kalp"), ("KAFA FM", "kafa"),
            ("DIYANET", "diyanet")
        ]
        ...
        for i in range(0, len(stations), 3):
            row = []
            for name, cid in stations[i:i+3]:
                row.append(_ikb(text=f"⦿ {name} ⦿", callback_data=f"radio {cid}"))
            keyboard.append(row)
    ...
    def start_key(self, lang: dict, private=False):
        if private:
            ...
            rows = [
                ...
                [
                    _ikb(text=lang["aloneowner"], url=f"tg://user?id={config.OWNER_ID}", style="danger", icon_custom_emoji_id=EMOJI_MOON)
                ],
